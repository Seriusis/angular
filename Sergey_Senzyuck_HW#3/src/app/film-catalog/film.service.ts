...
export class FilmService {
  ...
  getFilms = () => this.films.slice(0, this.pageConfig.end)

  updatePage(){
    this.pageConfig.currentPage++;
    this.pageConfig.itemsPerPage += this.pageConfig.step;
    this.pageConfig.end = this.pageConfig.itemsPerPage;
  }

  isLastPage = () => (this.pageConfig.itemsPerPage * this.pageConfig.currentPage) >= (this.films.length);
}
